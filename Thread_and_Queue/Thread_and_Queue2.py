...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def clickMethod(self):
        ...
        _plot_change_ref=True #grafiği tekrar boyutlandırmak için
        TAKEN_DATA_SAMPLES=self.line.text() 
    ...
    def update_plot(self):
        ...
        if self._plot_ref is None:
        ...
        elif _plot_change_ref is True:
            _plot_change_ref=False #birdaha bu döngüye data sayısı değişmediği sürece girmez
            #canvas siler
            ...
            self.canvas.axes2.plot(self.x2data, self.y2data, '.') 
